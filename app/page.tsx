...
export const metadata: Metadata = {
  ...
  description: '新人Vtuber「猫喰ぐるる」の公式ポートフォリオサイト。歌ってみた、ゲーム配信、雑談などの活動情報を発信中！',
  keywords: ['猫喰ぐるる', 'ねこはみぐるる', '新人V', '新人Vtuber', '個人勢Vtuber', 'バーチャルYouTuber', '歌ってみた', 'ゲーム実況', '雑談配信'],
};
...
export default function Home() {
  ...
  return (
    <main className="min-h-screen bg-[#453e40] text-[#f4ebeb] font-sans overflow-x-hidden selection:bg-red-500/30 relative">
      ...
      <div className="w-full min-h-screen relative z-10">
        ...
        <header className="fixed top-0 w-full h-16 bg-[#453e40]/90 backdrop-blur-sm border-b border-white/10 z-[60] flex items-center justify-between px-6 md:px-16 shadow-sm">
          <div className="flex items-center gap-2">
            ...
            <div className="text-red-300 font-bold text-base tracking-[0.1em] cursor-default drop-shadow-[0_0_5px_rgba(248,113,113,0.3)]">
              猫喰ぐるる
            </div>
          </div>
        ...
        <section id="top" className="min-h-screen flex flex-col md:flex-row items-center justify-center px-6 md:px-24 pt-16 lg:mb-32 relative scroll-mt-24">
          <div className="flex-1 text-center md:text-left z-10 order-2 md:order-1 lg:pl-10">
            <div className="inline-block px-3 py-1 rounded-full border border-red-300/40 text-red-300/90 text-[10px] tracking-widest mb-6 bg-red-900/10">
              NEW GENERATION VTUBER
            </div>
            ...
            <p className="text-[#c2b6b8] text-xs lg:text-sm tracking-[0.3em] mt-2 font-bold uppercase">Nekohami Gururu</p>
          </div>
        ...
        <footer className="py-20 px-6 text-center bg-[#3a3335] border-t border-white/5 relative z-20">
          ...
          <div className="mb-12 flex flex-col items-center gap-6">
            ...
            <p className="text-xs text-[#a89c9e] tracking-widest font-bold">
              WEB SITE DESIGNED BY: <span className="text-white/80">あなたのお名前🐾</span>
            </p>
          </div>
